...
from .schema_generator import PostGISSchemaGenerator
...
class AsyncpgDBClient(BaseDBAsyncClient):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.connection_class = self.extra.pop(
    ...
    async def create_connection(self, with_db: bool) -> None:
        ...
        try:
            ...
            self.log.debug(
                "Created connection pool %s with params: %s", self._pool, self._template
            )
    ...
    async def _close(self) -> None:
        if self._pool:  # pragma: nobranch
            ...
            self._pool = None
            self.log.debug(
                "Closed connection pool %s with params: %s", self._pool, self._template
            )
